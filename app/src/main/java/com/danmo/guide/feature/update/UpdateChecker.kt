...
class UpdateChecker {
    companion object {
        private const val VERSION_URL = "https://guangji.online/update/metadata/version.txt"
        private const val CHANGELOG_URL = "https://guangji.online/update/metadata/changelog.txt"
    }
